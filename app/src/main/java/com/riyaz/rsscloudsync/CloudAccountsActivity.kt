...
class CloudAccountsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCloudAccountsBinding.inflate(layoutInflater); setContentView(binding.root)
        setSupportActionBar(binding.toolbar); supportActionBar?.setDisplayHomeAsUpEnabled(true); supportActionBar?.title = "Cloud accounts"
    ...
    private fun setupEmptyStateButton() {
        ...
        val button = MaterialButton(this).apply { text = "ADD CLOUD ACCOUNT"; isAllCaps = false; textSize = 14f; setTextColor(Color.WHITE); cornerRadius = dp(24); background = android.graphics.drawable.GradientDrawable(android.graphics.drawable.GradientDrawable.Orientation.LEFT_RIGHT, intArrayOf(Color.rgb(124,61,237), Color.rgb(38,181,235))).apply { cornerRadius = dp(24).toFloat() }; setOnClickListener { binding.googleDriveConnect.performClick() } }
